    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card>
            <CardHeader>
              <CardTitle>Active Supervisions</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-gray-600">No active supervisions to display.</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-gray-600">No recent reports submitted.</p>
            </CardContent>
          </Card>
        </div>
      </main>
